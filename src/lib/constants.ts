...
export const CONFIG = {
  ...
  DEFAULT_FAQS: [
    { question: `How do I earn ${COIN_SYMBOL_VALUE}?`, answer: `You earn ${COIN_SYMBOL_VALUE} by tapping the main coin on the Mining page. You can also earn through daily bonuses, achievements, quests, and referrals.`, category: 'General', order: 1, icon: Lightbulb },
    { question: 'What are boosters?', answer: `Boosters are upgrades you can buy with ${COIN_SYMBOL_VALUE} to increase your tap power or maximum energy, helping you earn faster.`, category: 'Gameplay', order: 2, icon: Zap },
    { question: `How do I redeem my ${COIN_SYMBOL_VALUE}?`, answer: `Go to the Redeem page, enter the amount you want to withdraw (minimum ${MIN_REDEEM_VALUE} ${COIN_SYMBOL_VALUE}), choose your payment method, and fill in the details.`, category: 'Redeem', order: 3, icon: Briefcase },
    { question: 'How often do quests update?', answer: 'Daily quests update every 24 hours. Make sure to complete and claim them before they reset!', category: 'Quests', order: 4, icon: Star },
    { question: 'Is my data safe?', answer: 'We prioritize your security. Your data is stored securely using Firebase, and we follow best practices to protect your information.', category: 'Account', order: 5, icon: Users },
