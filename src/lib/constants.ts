...
import { Award, BarChartBig, CheckCircle, Palette, Gem } from 'lucide-react';

export const CONFIG = {
  APP_NAME: "SDF Miner", // Changed back to SDF Miner
  COIN_SYMBOL: "SDF", // Changed from TITAN to SDF
  MIN_REDEEM: 1000, // Changed from 100 to 1000
  ...
  BOOSTERS: [
    ...
    {
      id: 'energy_regen_1', name: 'Energy Regen Boost I', description: 'Increase max energy significantly by 75.', // Effect remains boosting max energy
